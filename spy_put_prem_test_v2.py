...
result['spy_ret_limit_loss_fl'] = result.apply(lambda x: 1 if x[str(ret_days)+'d_max_loss']>(x['1M20DP']+0.01) else 0, axis=1)
...
result.to_excel("spy_test_result_strike_distance.xlsx")
test_result.to_excel("spy_predict_result_strike_distance.xlsx")
